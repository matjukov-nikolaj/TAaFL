...
<form id="form" method="post">
    ...
    <%
        ...
        ArrayList<ArrayList<Cell>> lol = (ArrayList<ArrayList<Cell>>)request.getAttribute("c");
        out.print("<table>");
        for (int i = 0; i <= x; ++i) {
            out.print("<tr>");
            for (int j = 0; j <= lol.size(); ++j) {
                ...
                if (i > 0 && j == 0) {
                    ...
                    if (i == 0) {
                        String value = lol.get(j - 1).get(i).y.toString();
                        out.print("<td><p>" + value + " </p></td>");
                    } else {
                        String q = lol.get(j - 1).get(i - 1).Q.toString();
